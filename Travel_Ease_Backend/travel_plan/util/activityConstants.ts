...
export const BUDGET_RANGE_FROM_PRISMA: Record<string, string> = Object.fromEntries(
 ...
 */
export function normalizeBudgetRange(value: string | null | undefined): string | null {
 ...
 */
export function formatActivity(activity: ActivityData, extras: Record<string, any> = {}): Record<string, any> {
 ...
 */
export function formatActivities(activities: ActivityData[]): Record<string, any>[] {
