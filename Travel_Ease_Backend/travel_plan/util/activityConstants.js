 ...
 *   - Zod validation schemas (src/schemas/validation.js)
...
export const BUDGET_RANGE_TO_PRISMA = {
  '0-100': 'RANGE_0_100',
...
export const BUDGET_RANGE_FROM_PRISMA = Object.fromEntries(
 ...
 * @param {string} value - Budget range value
 * @returns {string|null} - Prisma enum value or null if invalid
 */
export function normalizeBudgetRange(value) {
 ...
 * @param {object} activity - Prisma model instance or plain object
 * @param {object} extras - Additional fields to merge
 * @returns {object} - Normalized activity DTO
 */
export function formatActivity(activity, extras = {}) {
