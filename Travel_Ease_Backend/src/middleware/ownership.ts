 ...
 */
export const requirePlanOwnership = async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const requireBusinessOwnership = async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const requireActivityAccess = async (req: Request, res: Response, next: NextFunction) => {
