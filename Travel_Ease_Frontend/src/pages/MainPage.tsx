          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {isAuthenticated && (
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary-red text-white rounded-xl font-medium hover:bg-primary-red-dark transition-colors shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-primary-red focus:ring-offset-2"
              >
