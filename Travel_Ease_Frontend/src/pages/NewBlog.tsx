...
export default function NewBlog(): React.ReactElement {
  ...
  const { user, loading, isGoogleAuth, isConfigured, signInWithGoogle } = useAuth();
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Google Authentication Required</h1>
            <p className="text-gray-600 mb-6">
              To publish blog posts on TravelEase, you need to sign in with your Google account.
              This helps us verify authors and maintain quality content.
            </p>
            {user ? (
              // User is logged in but not with Google
              <div className="space-y-4">
                <p className="text-sm text-gray-500">
                  You're currently signed in with email/password. Please link your Google account to publish.
                </p>
                {isConfigured && (
                  <button
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  ...
                  <Link to="/signup" className="text-primary-red hover:text-primary-red-dark">
                    Sign up
                  </Link>
                </p>
              </div>
