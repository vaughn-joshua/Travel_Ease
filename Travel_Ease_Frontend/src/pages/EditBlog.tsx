...
export default function EditBlog(): React.ReactElement {
  ...
  const { user, loading: authLoading, isGoogleAuth, isConfigured, signInWithGoogle } = useAuth();
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              To edit blog posts on TravelEase, you need to sign in with your Google account.
            </p>
            {user ? (
              <div className="space-y-4">
                <p className="text-sm text-gray-500">
                  You're currently signed in with email/password. Please link your Google account to edit blogs.
                </p>
                {isConfigured && (
                  <button
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <Link to="/blogs" className="text-primary-red hover:text-primary-red-dark transition-colors">
                ← Back to Blogs
              </Link>
            </div>
          </div>
