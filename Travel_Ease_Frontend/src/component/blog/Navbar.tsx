...
const Navbar: React.FC = () => {
  ...
  const { user, loading, isConfigured, isGoogleAuth, signInWithGoogle, signOut } = useAuth();
    ...
    <header className="sticky top-0 z-50 bg-white/90 shadow-sm backdrop-blur-lg">
      ...
      >
        ...
        <div className="hidden items-center gap-3 md:flex">
          {/* Show Publish only for Google-authenticated users */}
            ...
            <div className="flex items-center gap-2">
              ...
              {!isGoogleAuth && isConfigured && (
                <button
                  ...
                  title="Sign in with Google to publish blogs"
                >
