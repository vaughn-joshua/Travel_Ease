...
export function ProfileSidebar({
  ...
  return (
    <div className="w-full md:w-64 bg-white border-b md:border-b-0 md:border-r border-gray-200 flex md:flex-col md:sticky md:top-0 md:self-start">
      ...
      <div className="hidden md:flex md:flex-col md:h-[calc(100vh-4rem)] md:w-64">
