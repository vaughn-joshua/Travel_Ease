...
export default function PublicPlans(): React.ReactElement {
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-xs text-gray-400 mt-1">
          Check back later for community plans
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="h-full min-h-0 flex flex-col">
      <div className="flex-1 min-h-0 grid grid-rows-3 gap-3">
        {paginatedPlans.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={`group relative p-3 rounded-xl border cursor-pointer transition-all duration-200 h-full overflow-hidden ${
                isJoined
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                <h4
                  className={`font-semibold text-gray-900 line-clamp-1 mb-1 transition-colors ${
      ...
      {/* Pagination controls */}
      <div className="h-14 shrink-0 mt-3 flex items-center justify-between border-t border-gray-100">
        <button
