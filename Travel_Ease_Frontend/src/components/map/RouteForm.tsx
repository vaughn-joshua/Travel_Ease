    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2-1h2m6 0h2l2 1V8a1 1 0 00-1-1h-2"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14l-2 8m4-8l2 8m-6-4h4"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M15 6l-4 8h6l-3 3.5M5.5 17.5L9 10l3 4"
        />
      </svg>
    ),
  },
...
export default function RouteForm({
  ...
  profile,
  onProfileChange,
}: RouteFormProps): React.ReactElement {
  ...
  const handleSubmit = (e: React.FormEvent): void => {
    ...
    if (
      startPoint &&
      endPoint &&
      startPoint.lat !== undefined &&
      startPoint.lng !== undefined &&
    ...
    <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-lg shadow-black/10 border border-white/60 overflow-visible relative z-[9996]">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <span
              className={`text-sm font-semibold block ${hasRoute ? "text-green-700" : "text-gray-900"}`}
            >
      ...
      >
        <form
          ...
          className="p-4 pt-0 space-y-4 border-t border-gray-100 max-h-[min(560px,calc(70dvh-2.5rem))] overflow-visible overscroll-contain scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
        >
          {/* From Field */}
